...
public class CertCmdArgUtil
{
    ...
    public static Subject initSubject(ArgumentMap argMap, boolean returnNullOnNotFound)
    {
        ...
        else
        {
            ...
            catch (RuntimeException ex) { ex1 = ex; }
            ...
            if (subject == null)
                ...
                catch (RuntimeException ex) { ex2 = ex; }
            if (!returnNullOnNotFound)
                throw new RuntimeException("Could not find valid certificate files at "
                        + strCertKey + " or " + strCert + "," + strKey, ex2);
        }
        return subject;
    }
}
