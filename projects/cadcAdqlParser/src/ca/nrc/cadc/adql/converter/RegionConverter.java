...
import ca.nrc.cadc.adql.impl.postgresql.pgsphere.converter.RegionConverterImpl;
import ca.nrc.cadc.adql.validator.ColumnReferenceValidator;
import ca.nrc.cadc.adql.validator.ExpressionValidator;
import ca.nrc.cadc.adql.validator.Validator;
 ...
 */
public abstract class RegionConverter implements SelectVisitor, FromItemVisitor {
    protected static Logger log = Logger.getLogger(RegionConverter.class);
	...
	public abstract void visit(SubSelect subSelect);
	public abstract void visit(SubJoin subjoin);
