...
import ca.nrc.cadc.adql.config.meta.ColumnMeta;
...
public class PlainSelectInfo {
	...
	protected List<FromColumn> fromColumns = new ArrayList<FromColumn>();

	public int countMatches(Column c1) {
		int count = 0;
		for (FromColumn fromColumn : this.fromColumns) {
