 ...
 * 
 */
package ca.nrc.cadc.adql.exception;

/**
 * @author zhangsa
 *
 */
public class AdqlValidateException extends AdqlException {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2418812892240742354L;

	/**
	 * 
	 */
	public AdqlValidateException() {
	 ...
	 * @param message
	 */
	public AdqlValidateException(String message) {
		super(message);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public AdqlValidateException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public AdqlValidateException(String message, Throwable cause) {
		super(message, cause);
		// TODO Auto-generated constructor stub
	}
