...
import ca.nrc.cadc.adql.impl.postgresql.pgsphere.AdqlManagerImpl;
...
public class AdqlParserTest {
	...
	public void setUp() throws Exception {
		...
		AdqlManager manager = new AdqlManagerImpl();
	...
	/**
	 * Test method for {@link ca.nrc.cadc.adql.AdqlParser#AdqlParser(ca.nrc.cadc.adql.config.AdqlConfig)}.
	 */
	//@Test
	public void testAdqlParser() {
		
		fail("Not yet implemented"); // TODO
	}

	/**
	 * Test method for {@link ca.nrc.cadc.adql.AdqlParser#parse(java.lang.String)}.
	 */
	//@Test
	public void testParse() {
		try {
			sqlOutput = adqlParser.parse(adqlInput);
