...
public class UserServiceIntegrationTest extends AbstractIntegrationTest
{
    private final static Logger LOGGER =
            Logger.getLogger(UserServiceIntegrationTest.class);
    ...
    @Test
    public void getNonMemberReverse() throws Exception
    {
    ...
    public void getMemberGroups() throws Exception
    {
        ...
        final WebResponse response = webConversation.getResource(getRequest);
        assertEquals("Should be Not Implemented message.",
                     String.format("The Service to see Member with ID "
                                   + "'%s' is not yet implemented.",
                                   Long.toString(88l)), response.getText());
    }
}
