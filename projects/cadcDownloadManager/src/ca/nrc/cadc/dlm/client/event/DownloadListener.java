...
public interface DownloadListener
{
     ...
     * @param e
     */
    void downloadEvent(DownloadEvent e);
    
    /**
     * Get the transfer protocol header (typically http header) used to carry a custom
     * event identifier. If this method returns a non-null value, Download will try to get
     * a value from the ransfer protocol and add it to any DownloadEvent objects it creates.
     * 
