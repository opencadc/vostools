...
import ca.nrc.cadc.tap.upload.datatype.MySQLDataType;
import ca.nrc.cadc.tap.upload.datatype.PostgreSQLDataType;
import ca.nrc.cadc.tap.upload.datatype.SybaseDataType;
...
public class DatabaseDataTypeFactory
{
    ...
    /**
     * Expected String returned by getDatabaseProductName.
     */
    public static final String MYSQL = "mysql";
    public static final String POSTGRESQL = "postgresql";
    public static final String SYBASE = "adaptive server enterprise";
     ...
     * @throws SQLException
     */
    public static DatabaseDataType getDatabaseDataType(Connection con)
        throws SQLException
    {
        ...
        if (databaseMetaData != null)
        {
            ...
            if (database.equalsIgnoreCase(SYBASE))
                return new SybaseDataType();
        }

        // If the JDBC driver doesn't support metadata or if the meta data
        // database product name doesn't match known databases.
