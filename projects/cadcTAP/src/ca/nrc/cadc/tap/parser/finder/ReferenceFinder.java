 ...
 *
 */
public class ReferenceFinder extends ReferenceNavigator
{
    protected static Logger log = Logger.getLogger(ReferenceFinder.class);
    
    public ReferenceFinder clone()
    {
        ReferenceFinder rtn = (ReferenceFinder) super.clone();
        return rtn;
    }
