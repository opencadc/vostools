...
public class SelectListExtractorNavigator extends SelectNavigator
{
    /**
     * @param en
     * @param rn
     * @param fn
     */
    public SelectListExtractorNavigator(ExpressionNavigator en, ReferenceNavigator rn, FromItemNavigator fn)
    {
        super(en, rn, fn);
    }
