...
import ca.nrc.cadc.gms.server.web.restlet.MemberResource;

public class MemberResourceTest extends AbstractResourceTest<MemberResource>
{
    /**
    ...
    {
        setTestSubject(new MemberResource());
    }
}
