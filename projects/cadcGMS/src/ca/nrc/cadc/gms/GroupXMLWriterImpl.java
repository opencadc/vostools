        ...
        extends AbstractOutputStreamWriterImpl implements GroupXMLWriter
{
    ...
    {
        final Element rootMemberElement = new Element("group");
        rootMemberElement.setAttribute("id", getGroup().getGMSGroupID());
        
        UserXMLWriter userXMLWriter;
        for (User user : getGroup().getMembers())
        {
            // TODO: write the member infor using the UserXMLWriterImpl
        }
