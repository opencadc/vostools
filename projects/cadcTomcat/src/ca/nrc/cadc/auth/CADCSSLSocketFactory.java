 ...
 *
 */
public class CADCSSLSocketFactory extends JSSE14SocketFactory
{
    
    private static Logger log = Logger.getLogger(CADCSSLSocketFactory.class);
    
    public CADCSSLSocketFactory()
    {
        super();
    }

    @Override
    public TrustManager[] getTrustManagers(java.lang.String keystoreType, java.lang.String algorithm) throws Exception
    {
        log.info("Creating CADC Trust Manager.");
        KeyStore trustStore = super.getTrustStore(keystoreType);
