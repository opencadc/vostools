...
/**
 * Create an XML representation of the list of Views
 * 
 * @author majorb
 *
 */
public class ViewsRepresentation extends OutputRepresentation
{
    ...
    public ViewsRepresentation(List<String> accepts, List<String> provides, ViewsWriter viewsWriter)
    {
    ...
    {
        viewsWriter.write(accepts, provides, outputStream);
    }
