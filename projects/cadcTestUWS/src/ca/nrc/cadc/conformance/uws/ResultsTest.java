...
public class ResultsTest extends TestConfig
{
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < propertiesFiles.length; i++)
        {
            ...
            assertNotNull("id property is not set in propertiess file " + propertiesFilename, id);

            // Result element xlink:href value.
            String href = properties.getProperty("href");
            log.debug(propertiesFilename + " href: " + href);
            assertNotNull("href property is not set in propertiess file " + propertiesFilename, href);
