...
public class ErrorTest extends TestConfig
{
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < propertiesFiles.length; i++)
        {
            ...
            String errorDetail = properties.getProperty("error.detail");
            log.debug(propertiesFilename + " error.detail: " + errorDetail);
            assertNotNull("error.detail property is not set in properties file " + propertiesFilename, errorDetail);
            ...
            // Get the phase resource for this jobId.
            resourceUrl = baseUrl + "/" + jobId + "/error";
            log.debug("**************************************************");
            ...
            Node uwsDetail = list.item(0);
            log.debug("uws:detail: " + uwsDetail.getTextContent());
            assertEquals(propertiesFilename + " uws:detail element does not match expected in XML returned from GET of " + resourceUrl, errorDetail, uwsDetail.getTextContent());
